...
public class CartAdapter extends ArrayAdapter<CartBean> {
    private LogUtility log = LogUtility.getInstance(CartAdapter.class);
    ...
    @SuppressLint("NewApi")
    public void setData(List<CartBean> data, Boolean isHasMsgData) {
        clear();
        if (data != null) {
            if (isHasMsgData) {
                addAll(data);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CartBean itemData = getItem(position);
