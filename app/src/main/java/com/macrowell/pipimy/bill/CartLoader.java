 ...
 * @author chris.cheng
 */
public class CartLoader extends
        AsyncTaskLoader<List<CartBean>> {
    private LogUtility log = LogUtility.getInstance(CartLoader.class);
    ...
    String apiUrl = Constant.API_URL + "ListShoppingCartItem.ashx";
    ...
    @Override
    public List<CartBean> loadInBackground() {

        List<CartBean> meData = new ArrayList<CartBean>();
