...
public abstract class ImageWorker {
    private static final LogUtility logger = LogUtility.getInstance(ImageWorker.class);
    ...
    public void loadImage(Object data, ImageView imageView, Bitmap loadingBitmap) {
        ...
        if (bitmap != null) {
            ...
            if (VersionUtility.hasHoneycomb()) {
    ...
    public static void cancelWork(ImageView imageView) {
        ...
        if (bitmapWorkerTask != null) {
            ...
            logger
                .d("cancelWork - cancelled work for " + bitmapWorkerTask.data);
        }
    }
