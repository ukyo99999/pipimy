...
import com.macrowell.pipimy.utility.VersionUtility;

/**
 * This class holds our bitmap caches (memory and disk).
 */
public class ImageCache {
    private static final LogUtility logger = LogUtility.getInstance(ImageCache.class);
    ...
    private void init(ImageCacheParams cacheParams) {
        ...
        if (mCacheParams.memoryCacheEnabled) {
            logger.d("Memory cache created (size = "
                ...
                if (mCacheParams.diskCacheEnabled && diskCacheDir != null) {
                    ...
                    if (getUsableSpace(diskCacheDir) > mCacheParams.diskCacheSize) {
                        try {
                            ...
                            logger.e("initDiskCache - " + e.getMessage(), e);
                        }
                    }
                }
            }
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                ...
                try {
                    ...
                    logger.e("addBitmapToCache - " + e.getMessage(), e);
                } catch (Exception e) {
                    logger.e("addBitmapToCache - " + e.getMessage(), e);
                } finally {
                    try {
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null) {
                ...
                try {
                    ...
                    logger.e("getBitmapFromDiskCache - " + e, e);
                } finally {
                    try {
                        if (inputStream != null) {
                            inputStream.close();
        ...
        synchronized (mDiskCacheLock) {
            ...
            if (mDiskLruCache != null && !mDiskLruCache.isClosed()) {
                try {
                    ...
                    logger.e("clearCache - " + e.getMessage(), e);
                }
                mDiskLruCache = null;
                initDiskCache();
            }
    ...
    public static int getBitmapSize(Bitmap bitmap) {
        if (VersionUtility.hasHoneycombMR1()) {
    ...
    public static boolean isExternalStorageRemovable() {
        if (VersionUtility.hasGingerbread()) {
    ...
    public static RetainFragment findOrCreateRetainFragment(FragmentManager fm) {
        ...
        RetainFragment mRetainFragment = (RetainFragment) fm
            .findFragmentByTag(logger.getTag());

        // If not retained (or first time running), we need to create and add
        // it.
        if (mRetainFragment == null) {
            mRetainFragment = new RetainFragment();
            fm.beginTransaction().add(mRetainFragment, logger.getTag())
